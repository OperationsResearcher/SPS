    ...
    if (editModal) {
      ...
      document.getElementById("btn-edit-modal-save")?.addEventListener("click", async () => {
        ...
        try {
          ...
          if (!d.success) { showError(d.message || "İşlem başarısız."); return; }
          ...
          if (file && tid) {
            ...
            if (!ld.success) {
              showError(ld.message || "Kurum kaydedildi ancak logo yüklenemedi. Logo dosyasını kontrol edip Kaydet ile tekrar deneyin.");
              return;
            }
          }
          closeTenantModal();
