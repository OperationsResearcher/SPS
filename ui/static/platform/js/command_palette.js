...
(function () {
  ...
  const STATIC_PAGES = [
    ...
    // Girdi katmanı (/k-plan/) — katman mimarisi Faz 3, 2026-07-17
    { title: t("Stratejik Planlama"),      url: "/k-plan/strategy",   icon: "fa-bullseye",             group: t("Sayfa") },
    { title: t("Yönetici Paneli"),         url: "/k-plan/strategy/exec-dashboard", icon: "fa-tachometer-alt", group: t("Sayfa") },
    { title: t("X-Matrix"),                url: "/k-plan/strategy/xmatrix", icon: "fa-th-large",       group: t("Sayfa") },
    { title: t("Girişimler"),              url: "/k-plan/strategy/initiatives", icon: "fa-rocket",     group: t("Sayfa") },
    { title: t("Senaryolar"),              url: "/k-plan/strategy/scenarios", icon: "fa-code-branch",  group: t("Sayfa") },
    { title: t("Çeyreklik Değerlendirme"), url: "/k-plan/strategy/ceyreklik-review", icon: "fa-calendar-check", group: t("Sayfa") },
    { title: t("Yeniden Planlama Tetikleyicileri"), url: "/k-plan/strategy/replan-triggers", icon: "fa-bell", group: t("Sayfa") },
    { title: t("Mavi Okyanus"),            url: "/k-plan/strategy/blue-ocean", icon: "fa-water",       group: t("Sayfa") },
    { title: t("VRIO"),                    url: "/k-plan/strategy/vrio", icon: "fa-shield-halved",     group: t("Sayfa") },
    { title: t("Strateji Haritası"),       url: "/k-plan/strategy/strategy-map", icon: "fa-diagram-project", group: t("Sayfa") },
    { title: t("SP Menüsü"),               url: "/k-plan/strategy/menu", icon: "fa-th",                group: t("Sayfa") },
    { title: t("Süreç Yönetimi"),          url: "/k-plan/process",    icon: "fa-sitemap",              group: t("Sayfa") },
    { title: t("Proje Yönetimi"),          url: "/k-plan/project",    icon: "fa-folder-open",          group: t("Sayfa") },
    { title: t("Proje Portföyü"),          url: "/k-plan/project/portfolio", icon: "fa-layer-group",   group: t("Sayfa") },
    // NOT: "Proje Gantt"/"Proje Kanban" girdileri kaldırıldı — /project/gantt ve
