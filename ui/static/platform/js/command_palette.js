...
(function () {
  ...
  const STATIC_PAGES = [
    ...
    { title: "Çeyreklik Review",        url: "/sp/ceyreklik-review", icon: "fa-calendar-check",     group: "Sayfa" },
    { title: "Replan Tetikleyiciler",   url: "/sp/replan-triggers", icon: "fa-bell",                group: "Sayfa" },
    { title: "Blue Ocean",              url: "/sp/blue-ocean",     icon: "fa-water",                group: "Sayfa" },
    ...
    { title: "K-Radar (Raporlar)",      url: "/raporlar",          icon: "fa-satellite-dish",       group: "Sayfa" },
