...
(function () {
  ...
  const PG_UPDATE_BASE = root.dataset.pgUpdateBase || "/k-plan/individual/api/pi/update/";
  ...
  function seriesUrl(pgId, year) {
    if (!PG_SERIES_TEMPLATE) return `/k-plan/individual/api/pi/${pgId}/series?year=${year}`;
