/**
 * RAID sayfası — `window.RAID_PAGE_PROJECT_ID` ve isteğe bağlı `window.APP_API_BASE` kullanır.
 */
(function () {
  "use strict";
  function pid() {
    return String(
      window.RAID_PAGE_PROJECT_ID ||
        window.MICRO_RAID_PROJECT_ID ||
        ""
    );
  }
  function apiRaid() {
    var raw =
      (typeof window.APP_API_BASE === "string" && window.APP_API_BASE) ||
      (typeof window.MICRO_API_BASE === "string" && window.MICRO_API_BASE) ||
      "";
