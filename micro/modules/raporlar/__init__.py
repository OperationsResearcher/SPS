# Raporlar modülü — yeni rapor önerileri için staging bölüm.
# Kullanıcı sonradan her raporu uygun modüle taşıyacak.
from . import routes  # landing — defines /raporlar
