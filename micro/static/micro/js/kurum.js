...
(function () {
  ...
  // ── Ana Strateji Ekle (üst düğme + boş durum) ─────────────────────────────
  function wireStrategyAddButton(btn) {
  ...
  wireStrategyAddButton(document.getElementById("btn-strategy-add"));
  wireStrategyAddButton(document.getElementById("btn-strategy-add-empty"));
