...
MODULES = [
    {
        ...
        "url": "/desktop",
        "icon": "🏠",
        "description": _("Kişisel özet — tüm modüllerden gelen görevler, KPI'lar ve iş planları"),
    },
    {
        "id": "sp",
    ...
    },
    {
        ...
        "url": "/organization",
        "icon": "🏢",
        "description": _("Stratejik kimlik, kurum bilgileri ve strateji yönetimi"),
    },
    {
        "id": "bireysel",
    ...
    },
    {
        ...
        "url": "/k-radar",
        "icon": "🛰️",
        "description": _("KS, KP, KPR ve Cross radarlarıyla kurum çapı karar desteği"),
    },
    {
        "id": "k_rapor",
        "name": _("K-Rapor"),
    ...
    },
    {
        ...
        "url": "/admin/users",
        "icon": "🛡️",
        "description": _("Kullanıcı, kurum ve paket yönetimi"),
    },
    {
        "id": "api",
        "name": _("API Dokümantasyonu"),
        "url": "/api/docs",
        "icon": "📡",
        "description": _("REST API v1 endpoint referansı"),
    },
    {
        "id": "ayarlar",
        "name": _("Ayarlar"),
        "url": "/settings",
        "icon": "⚙️",
        "description": _("Kurum ve kullanıcı ayarları"),
    },
    {
        "id": "bildirim",
        "name": _("Bildirim Merkezi"),
        "url": "/notification",
        "icon": "🔔",
        "description": _("Sistem bildirimleri ve uyarılar"),
    },
]
